package com.injectbyreference;

import com.injectbyreference.beans.Person;
...
public class App 
{
    ...
    {
        ConfigurableApplicationContext appContext = new ClassPathXmlApplicationContext("com/injectbyreference/xml/beans.xml");
