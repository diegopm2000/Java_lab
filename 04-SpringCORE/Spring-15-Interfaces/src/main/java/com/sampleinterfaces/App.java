package com.sampleinterfaces;

import com.sampleinterfaces.beans.Player;
...
public class App
{
    ...
    {
        ConfigurableApplicationContext appContext = new ClassPathXmlApplicationContext("com/sampleinterfaces/xml/beans.xml");
