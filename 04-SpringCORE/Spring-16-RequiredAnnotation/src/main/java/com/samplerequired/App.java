package com.samplerequired;

import com.samplerequired.beans.Player;
...
public class App
{
    ...
    {
        ConfigurableApplicationContext appContext = new ClassPathXmlApplicationContext("com/samplerequired/xml/beans.xml");
